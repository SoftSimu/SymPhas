...
void testvirtualmodel()
{
	...
	{
		char name[64]{};
		symphas::io::copy_data_file_name(test_directory, "", i, i, DataFileType::CHECKPOINT_DATA, name);
	...
	symphas::io::copy_data_file_name(test_directory, "", 0, 0, DataFileType::CHECKPOINT_DATA, dir_with_name);
