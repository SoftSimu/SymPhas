...
symphas::b_element_type::b_element_type(b_element_type const& other) : b_element_type(other.type, other.tag, other.params, other.argc) {}

symphas::b_element_type::b_element_type(b_element_type&& other) noexcept : b_element_type()
{
	swap(*this, other);
}

symphas::b_element_type& symphas::b_element_type::operator=(b_element_type other)
{
...
symphas::b_element_type::~b_element_type()
{
	delete[] params;
}
...
std::map<const char*, BoundaryType, symphas::internal::any_case_comparator> symphas::internal::boundary_key_map = {
	{"DEFAULT", BoundaryType::DEFAULT},
	{"PERIODIC", BoundaryType::PERIODIC},
	{"OPEN", BoundaryType::OPEN}
};

std::map<const char*, BoundaryTag, symphas::internal::any_case_comparator> symphas::internal::boundary_tag_key_map = {
