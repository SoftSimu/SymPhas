...
ALLOW_COMBINATION((int N0, int N1),
                  (expr::symbols::internal::S2_symbol<N0, N1>))
ALLOW_COMBINATION((int N0, int N1, int N2),
                  (expr::symbols::internal::S3_symbol<N0, N1, N2>))

DEFINE_SYMBOL_ID(
    (int N), (expr::symbols::internal::S1_symbol<N>),
    static char* name = expr::print_with_subscript<N>("S").new_str();
    return name;)
DEFINE_SYMBOL_ID(
    (int N0, int N1), (expr::symbols::internal::S2_symbol<N0, N1>),
    static auto name1 = expr::print_with_subscript<N0>("S");
    static char* name2 = expr::print_with_subscript<N1>(name1.value).new_str();
    return name2;)
DEFINE_SYMBOL_ID(
    (int N0, int N1, int N2), (expr::symbols::internal::S3_symbol<N0, N1, N2>),
    static auto name1 = expr::print_with_subscript<N0>("S");
    static auto name2 = expr::print_with_subscript<N1>(name1.value);
    static char* name3 = expr::print_with_subscript<N2>(name2.value).new_str();
    return name3;)
...
constexpr auto get_stencil_symbols(
    std::integer_sequence<int, N0s...>,
    std::integer_sequence<int, N11, N12, N1s...>) {
  return expand_types_list<decltype(get_stencil_symbols(
                               std::integer_sequence<int, N0s...>{},
                               std::integer_sequence<int, N11>{})),
                           decltype(get_stencil_symbols(
                               std::integer_sequence<int, N0s...>{},
                               std::integer_sequence<int, N12, N1s...>{}))>{};
}

template <int... N0s, int N1, int N2>
constexpr auto get_stencil_symbols(std::integer_sequence<int, N0s...>,
                                   std::integer_sequence<int, N1>,
                                   std::integer_sequence<int, N2>) {
...
constexpr auto get_stencil_symbols(std::integer_sequence<int, N0s...>,
                                   std::integer_sequence<int, N11, N12, N1s...>,
                                   std::integer_sequence<int, N21>) {
  return expand_types_list<
      decltype(get_stencil_symbols(std::integer_sequence<int, N0s...>{},
                                   std::integer_sequence<int, N11>{},
                                   std::integer_sequence<int, N21>{})),
      decltype(get_stencil_symbols(std::integer_sequence<int, N0s...>{},
                                   std::integer_sequence<int, N12, N1s...>{},
...
template <int... N0s, int N11, int N12, int... N1s, int N21, int N22,
          int... N2s>
constexpr auto get_stencil_symbols(
    std::integer_sequence<int, N0s...>,
    std::integer_sequence<int, N11, N12, N1s...>,
    std::integer_sequence<int, N21, N22, N2s...>) {
  return expand_types_list<decltype(get_stencil_symbols(
                               std::integer_sequence<int, N0s...>{},
                               std::integer_sequence<int, N11, N12, N1s...>{},
                               std::integer_sequence<int, N21>{})),
                           decltype(get_stencil_symbols(
                               std::integer_sequence<int, N0s...>{},
                               std::integer_sequence<int, N11, N12, N1s...>{},
                               std::integer_sequence<int, N22, N2s...>{}))>{};
}

template <size_t D, int R>
constexpr auto get_stencil_symbols() {
  constexpr auto seq = seq_add(std::make_integer_sequence<int, 2 * R + 1>{},
                               seq_repeating_value_t<2 * R + 1, int, -R>{});
  if constexpr (D == 1) {
...
constexpr auto compare_symbols(expr::symbols::internal::S1_symbol<I0>,
                               expr::symbols::internal::S1_symbol<I1>) {
  return I0 < I1;
}

template <int I0, int J0, int I1, int J1>
constexpr auto compare_symbols(expr::symbols::internal::S2_symbol<I0, J0>,
                               expr::symbols::internal::S2_symbol<I1, J1>) {
  return (J0 == J1) ? (I0 < I1) : (J0 < J1);
}

template <int I0, int J0, int K0, int I1, int J1, int K1>
constexpr auto compare_symbols(expr::symbols::internal::S3_symbol<I0, J0, K0>,
                               expr::symbols::internal::S3_symbol<I1, J1, K1>) {
  return (K0 == K1) ? ((J0 == J1) ? (I0 < I1) : (J0 < J1)) : (K0 < K1);
}

// template<int... Is, int... Js, typename... Es>
// constexpr auto
// get_stencil_coeffs(types_list<std::pair<expr::symbols::internal::S2_symbol<Is,
// Js>, Es>...> const& dict)
//{
...
// constexpr auto
// get_stencil_coeffs(types_list<std::pair<expr::symbols::internal::S1_symbol<Is>,
// Es>...> const& dict)
//{
//	return std::tuple<Es...>{};
// }
...
// template<int... Is>
// constexpr auto
// get_stencil_coeffs(types_list<expr::symbols::internal::S1_symbol<Is>...>)
//{
//	return std::tuple<OpTerm<OpIdentity,
// expr::symbols::internal::S1_symbol<Is>>...>{};
// }
...
struct pack_dictionary<types_list<E0, Es...>,
  ...
  using type = expand_types_list<
      ...
      typename pack_dictionary<types_list<Es...>,
                               std::integer_sequence<int, Is...>>::type>;
};
...
// constexpr auto
// get_rows(types_list<std::pair<expr::symbols::internal::S2_symbol<I0, J0>,
// E0>>)
//{
//	return types_list<types_list<E0>>{};
// }

// template<int I0, int I1, int... Is, int J0, int J1, int... Js, typename E0,
// typename E1, typename... Es> constexpr auto get_rows(types_list<
//	std::pair<expr::symbols::internal::S2_symbol<I0, J0>, E0>,
...
//			std::pair<expr::symbols::internal::S2_symbol<I1, J1>,
// E1>, 			std::pair<expr::symbols::internal::S2_symbol<Is,
// Js>, Es>...>{}));

//		return expand_types_list<types_list<types_list<E0>>,
// next_list_t>{};
//	}
//	else
//	{
...
// unroll_types_list<next_list_t>>; 		using rest_t =
// types_after_at_index<1, unroll_types_list<next_list_t>>;
...
// template<size_t O, typename... E0s, typename... Es, size_t... Is, size_t N2 =
// sizeof...(Es) / 2> auto set_zeros_2d_row(types_list<E0s...>,
// types_list<Es...>, std::index_sequence<Is...>)
//{
//	if constexpr (O % 2 == 0)
//	{
//		using first_half_t = types_between_index<sizeof...(Is) + 1, N2 +
// 1, E0s...>; 		using center_t = types_list<type_at_index<N2, Es...>>;
...
//	else
//	{
//		using first_half_t = types_between_index<sizeof...(Is), N2,
// Es...>;
...
// template<size_t O, typename... E0s, typename... Es, size_t... Is, size_t N2 =
// sizeof...(Es) / 2> auto set_zeros_2d_row(types_list<Es...>,
// std::index_sequence<Is...>)
//{
//	if constexpr (O % 2 == 0)
//	{
//		using first_half_t = types_between_index<sizeof...(Is), N2,
// Es...>; 		using center_t = types_list<type_at_index<N2, Es...>>;
...
// auto set_zeros_2d(types_list<Es...> last_row, types_list<> const& rows,
// std::index_sequence<>)
//{
//	return types_list<>{};
// }
...
// auto set_zeros_2d(types_list<Es...> last_row, types_list<T0, Ts...> const&
// rows, std::index_sequence<>)
//{
//	using row_t = T0;
//	using rest_t = types_after_at_index<1, T0, Ts...>;

//	auto new_row = set_zeros_2d_row<O>(last_row, row_t{},
// std::index_sequence<>{});

//	return expand_types_list<
//		types_list<decltype(new_row)>,
//		decltype(set_zeros_2d<O, N>(new_row, rest_t{},
// std::index_sequence<>{}))>{};
//}

// template<size_t O, size_t N, typename... Es, typename... Ts, size_t I0,
// size_t... Is> auto set_zeros_2d(types_list<Es...> last_row, types_list<Ts...>
// const& rows, std::index_sequence<I0, Is...>)
//{
...
// auto set_zeros_2d(types_list<Ts...> const& rows, std::index_sequence<I0,
// Is...>)
//{
//	using row_t = type_at_index<0, Ts...>;
//	using rest_t = types_after_at_index<1, Ts...>;
...
//	constexpr size_t N1 = (N < I0) ? 0 : N - I0;
//	auto new_row = set_zeros_2d_row<O>(row_t{},
// std::make_index_sequence<N1>{});
...
template <int I, int J, typename T0, typename... Ts, int I0, int... Is, int J0,
          int... Js>
struct at_stencil_index_2d<I, J, types_list<T0, Ts...>,
                           std::integer_sequence<int, I0, Is...>,
                           std::integer_sequence<int, J0, Js...>> {
  using type =
      typename at_stencil_index_2d<I, J, types_list<Ts...>,
                                   std::integer_sequence<int, Is...>,
                                   std::integer_sequence<int, Js...>>::type;
};
...
auto simplify_axes_2d_odd(
    types_list<std::pair<
        expr::symbols::internal::S2_symbol<Is, Js>,
        OpTerm<OpIdentity, expr::symbols::internal::S2_symbol<Is, Js>>>...>) {
  using Ts = types_list<
      OpTerm<OpIdentity, expr::symbols::internal::S2_symbol<Is, Js>>...>;
  using nTs = types_list<
      OpTerm<OpNegIdentity, expr::symbols::internal::S2_symbol<Is, Js>>...>;

  return types_list<std::pair<
      expr::symbols::internal::S2_symbol<Is, Js>,
      typename at_stencil_index_2d<
          -fixed_abs<Is>, -fixed_abs<Js>, std::conditional_t<(Is < 0), Ts, nTs>,
          std::integer_sequence<int, Is...>,
          std::integer_sequence<int, Js...>>::type>...>{};
}

template <int... Is, int... Js>
auto simplify_axes_2d_even(
    types_list<std::pair<
        expr::symbols::internal::S2_symbol<Is, Js>,
        OpTerm<OpIdentity, expr::symbols::internal::S2_symbol<Is, Js>>>...>) {
  using Ts = types_list<
  ...
  return types_list<
      std::pair<expr::symbols::internal::S2_symbol<Is, Js>,
                typename at_stencil_index_2d<
                    -fixed_max<fixed_abs<Js>, fixed_abs<Is>>,
                    -fixed_min<fixed_abs<Js>, fixed_abs<Is>>, Ts,
                    std::integer_sequence<int, Is...>,
                    std::integer_sequence<int, Js...>>::type>...>{};
}
        ...
        types_list<std::conditional_t<
            Is == 0 || Js == 0 ||
                ((USE_RADIUS_CENTRAL_2D)
                     ? (test_in_radius<R / 2 - NEG_RADIUS_CENTRAL_2D + 1, Is,
                                       Js>)
                     : false),
            OpTerm<OpIdentity, expr::symbols::internal::S2_symbol<Is, Js>>,
            OpVoid>...>,
    ...
    return simplify_axes_2d_even(
        typename pack_dictionary<
            types_list<std::conditional_t<
                Is == 0 || Js == 0 ||
                    ((USE_RADIUS_CENTRAL_2D)
                         ? (test_in_radius<R / 2 - NEG_RADIUS_CENTRAL_2D, Is,
                                           Js>)
                         : false),
                OpTerm<OpIdentity, expr::symbols::internal::S2_symbol<Is, Js>>,
                OpVoid>...>,
...
template <int I, int J, int K, typename Ts, typename SeqI, typename SeqJ,
          typename SeqK>
struct at_stencil_index_3d;

template <int I, int J, int K, typename T0, typename... Ts, int I0, int... Is,
          int J0, int... Js, int K0, int... Ks>
struct at_stencil_index_3d<I, J, K, types_list<T0, Ts...>,
                           std::integer_sequence<int, I0, Is...>,
                           std::integer_sequence<int, J0, Js...>,
                           std::integer_sequence<int, K0, Ks...>> {
  using type =
      typename at_stencil_index_3d<I, J, K, types_list<Ts...>,
                                   std::integer_sequence<int, Is...>,
                                   std::integer_sequence<int, Js...>,
                                   std::integer_sequence<int, Ks...>>::type;
};

template <int I, int J, int K, typename T0, typename... Ts, int... Is,
          int... Js, int... Ks>
struct at_stencil_index_3d<I, J, K, types_list<T0, Ts...>,
                           std::integer_sequence<int, I, Is...>,
                           std::integer_sequence<int, J, Js...>,
                           std::integer_sequence<int, K, Ks...>> {
  using type = T0;
};

template <int... Is, int... Js, int... Ks>
auto simplify_axes_3d_odd(
    types_list<std::pair<expr::symbols::internal::S3_symbol<Is, Js, Ks>,
                         OpTerm<OpIdentity, expr::symbols::internal::S3_symbol<
                                                Is, Js, Ks>>>...>) {
  using Ts = types_list<
      OpTerm<OpIdentity, expr::symbols::internal::S3_symbol<Is, Js, Ks>>...>;
  using nTs = types_list<
      OpTerm<OpNegIdentity, expr::symbols::internal::S3_symbol<Is, Js, Ks>>...>;

  return types_list<std::pair<
      expr::symbols::internal::S3_symbol<Is, Js, Ks>,
      typename at_stencil_index_3d<
          -fixed_abs<Is>, -fixed_max<fixed_abs<Js>, fixed_abs<Ks>>,
...
auto simplify_axes_3d_even(
  ...
  return types_list<std::pair<
      ...
      typename at_stencil_index_3d<
          ...
          -fixed_min<fixed_max<fixed_abs<Is>, fixed_abs<Js>>,
                     fixed_max<fixed_abs<Is>, fixed_abs<Ks>>,
                     fixed_max<fixed_abs<Js>, fixed_abs<Ks>>>,
          -fixed_min<fixed_abs<Is>, fixed_abs<Js>, fixed_abs<Ks>>, Ts,
          std::integer_sequence<int, Is...>, std::integer_sequence<int, Js...>,
          std::integer_sequence<int, Ks...>>::type>...>{};
}
    ...
    return simplify_axes_3d_even(
        typename pack_dictionary<
            types_list<std::conditional_t<
                ((Is == 0 && Js == 0) || (Is == 0 && Ks == 0) ||
                 (Js == 0 && Ks == 0)) ||
                    ((USE_RADIUS_CENTRAL_3D)
                         ? test_in_radius<R / 2 - NEG_RADIUS_CENTRAL_3D, Is, Js,
                                          Ks>
                         : false),
                OpTerm<OpIdentity,
                       expr::symbols::internal::S3_symbol<Is, Js, Ks>>,
...
template <typename Symbol, typename E, typename IE,
          typename std::enable_if_t<
              (symphas::lib::index_of_type<Symbol, expr::op_types_t<E>> < 0),
              int> = 0>
...
template <typename E, typename Symbol0, typename E0, typename... Symbols,
          typename... Es>
auto make_all_substitutions(
    OpExpression<E> const& e,
    types_list<std::pair<Symbol0, E0>, std::pair<Symbols, Es>...>) {
  return make_all_substitutions(make_substitution<Symbol0>(E{}, E0{}),
...
struct match_select_impl<std::integral_constant<int, -1>, T, types_list<Ms...>,
                         types_list<Ls...>> {
  using type = types_list<>;
};

template <int N, typename T, typename... Ms, typename... Ls>
struct match_select_impl<std::integral_constant<int, N>, T, types_list<Ms...>,
                         types_list<Ls...>> {
...
struct match_select_impl<void, T, types_list<Ms...>, types_list<Ls...>> {
  using type = typename match_select_impl<
      std::integral_constant<int, index_of_type<T, Ms...>>, T,
      types_list<Ms...>, types_list<Ls...>>::type;
};
...
auto make_all_substitutions(types_list<std::pair<Symbols, Es>...> const& dict,
                            types_list<Ts...>, OpExpression<E> const& e) {
  using list_substitutions_t =
      expand_types_list<match_select<Ts, types_list<Symbols...>,
                                     types_list<std::pair<Symbols, Es>...>>...>;
...
auto back_substitution(
    types_list<std::pair<expr::symbols::internal::S1_symbol<Is>, Es>...> const&
        dict,
    OpExpression<E> const& expr) {
  return types_list<
      std::pair<expr::symbols::internal::S1_symbol<Is>,
                decltype(make_substitution<SymbolKey>(Es{}, E{}))>...>{};
}
...
//! Perform back substitution on the dictionary to update it.
template <typename SymbolKey, int... Is, int... Js, int... Ks, typename... Es,
          typename E>
auto back_substitution(
    types_list<std::pair<expr::symbols::internal::S3_symbol<Is, Js, Ks>,
                         Es>...> const& dict,
    OpExpression<E> const& expr) {
  return types_list<
      std::pair<expr::symbols::internal::S3_symbol<Is, Js, Ks>,
                decltype(make_substitution<SymbolKey>(Es{}, E{}))>...>{};
}
...
//
// template <typename S, typename E, size_t I0, size_t... Is>
// struct to_list_position<S, E, std::index_sequence<I0, Is...>> {
//  using elem =
//      decltype(expr::split::factor<sizeof...(Is) + 1, S>(std::declval<E>())
//                   .second);
//  using type =
//      types_list<OpVoid, symphas::type_ignore_index<Is, OpVoid>..., elem>;
//};
...
struct to_list_position<S, E, std::index_sequence<I0, Is...>> {
  ...
  using type = symphas::lib::types_list<
      OpVoid, std::conditional_t<true, OpVoid, std::index_sequence<Is>>...,
      elem>;
};

template <typename S, typename E>
struct to_list_position<S, E, std::index_sequence<>> {
  using type = types_list<E>;
};
...
struct extend_symbol_list<types_list<Es...>, std::index_sequence<I0, Is...>> {
  using type =
      types_list<Es..., OpVoid,
                 std::conditional_t<true, OpVoid, std::index_sequence<Is>>...>;
};

template <typename... Es>
struct extend_symbol_list<types_list<Es...>, std::index_sequence<>> {
  using type = types_list<Es...>;
};
...
struct merge_symbol_exprs<std::index_sequence<Is...>, Ts...> {
  using type = reverse_types_list<types_list<typename filter_amp<
      typename add_types_at_index<Is, Ts...>::type>::type...>>;
};

template <typename... E0s, typename... Ts>
struct merge_symbol_exprs<types_list<E0s...>, Ts...> {
  static const size_t N =
      fixed_max<sizeof...(E0s), types_list_size<Ts>::value...>;

  using type = typename merge_symbol_exprs<
      std::make_index_sequence<N>,
      typename extend_symbol_list<
          types_list<E0s...>,
          std::make_index_sequence<N - sizeof...(E0s)>>::type,
      typename extend_symbol_list<
          Ts, std::make_index_sequence<N - types_list_size<Ts>::value>>::
          type...>::type;
};
...
//! Generates a list of types of expressions from the given expression by
//! sorting the powers of the symbol in each term into list of types indices,
//! where the list index represents the multiplicative order of the given
//! variable `S` in that subexpression.
template <typename S, typename E>
struct collect_symbol_exprs {
  static const size_t I = expr::factor_count<S, E>::value;

  using type =
      typename to_list_position<S, E, std::make_index_sequence<I>>::type;
};

template <typename S, typename... Es>
struct collect_symbol_exprs<S, OpAdd<Es...>> {
  using type = typename merge_symbol_exprs<
      typename collect_symbol_exprs<S, Es>::type...>::type;
};

template <typename S, typename E1, typename E2>
struct collect_symbol_exprs<S, OpBinaryDiv<E1, E2>> {
  using type = typename divide_exprs<typename collect_symbol_exprs<S, E1>::type,
                                     E2>::type;
};
...
/*!
 * Finds the index of the first undefined symbol in the dictionary. A symbol is
 * undefined if it is associated with a variable of itself. I.e. given a symbol
 * `S`, it is undefined if its associated dictionary entry is `S,
 * OpTerm<OpIdentity, S>`.
 */
...
struct first_undefined_symbol<
    void, types_list<std::pair<Symbol0, E0>, std::pair<Symbols, Es>...>> {
 protected:
  ...
  static constexpr int get_index_no_matching() {
    if constexpr (I >= sizeof...(Symbols) + 1) {
      ...
      if constexpr (std::is_same<
                        ith_element,
                        std::pair<ith_symbol,
                                  OpTerm<OpIdentity, ith_symbol>>>::value) {
        return I;
      } else {
...
template <typename S0, typename... Ss, typename Symbol0, typename... Symbols,
          typename E0, typename... Es>
struct first_undefined_symbol<
    types_list<S0, Ss...>,
    types_list<std::pair<Symbol0, E0>, std::pair<Symbols, Es>...>>
    : first_undefined_symbol<
          void, types_list<std::pair<Symbol0, E0>, std::pair<Symbols, Es>...>> {
  using parent_type = first_undefined_symbol<
      void, types_list<std::pair<Symbol0, E0>, std::pair<Symbols, Es>...>>;
...
/*!
 * Determines whether the dictionary is complete or not. It is determined
 * complete if there are no undefined symbols.
 */
template <typename T>
...
struct dict_complete<types_list<std::pair<Symbols, Es>...>> {
 ...
 public:
  ...
  // get_value(std::make_index_sequence<sizeof...(Symbols)>{});
  static const bool value =
      !(std::is_same<Es, OpTerm<OpIdentity, Symbols>>::value || ...);
};

template <size_t O, size_t N, size_t R0 = O + N - 2>
constexpr size_t R_ = (R0 <= 1)       ? 1
                      : (R0 % 2 == 1) ? (R0 + 1) / 2
                                      : R0 / 2;
...
// Represents the vector which is a row vector when I = 0, column when I = 1 and
// depth when I = 2.
...
template <size_t I, typename... Es>
struct stencil_vector_type<
    1, I, symphas::lib::types_list<stencil_vector_type<0, I, Es>...>> {};

template <size_t I0, size_t I, typename... Es>
auto get_stencil_vector_entry(
...
auto get_stencil_vector_entry(
    expr::stencil_vector_type<
        1, I, symphas::lib::types_list<stencil_vector_type<0, 0, Es>...>>) {
  return get_stencil_vector_entry<I0>(
      symphas::lib::type_at_index<I1, stencil_vector_type<0, 0, Es>...>{});
}
...
auto operator*(
    OpTerm<V, G> const& term,
    expr::stencil_vector_type<N, I, symphas::lib::types_list<Es...>>) {
  return expr::stencil_vector_type<
      N, I, symphas::lib::types_list<mul_result_t<OpTerm<V, G>, Es>...>>{};
}

template <size_t I, size_t N, typename... Es, typename E>
auto operator*(expr::stencil_vector_type<I, N, symphas::lib::types_list<Es...>>,
               OpExpression<E> const& term) {
  return expr::stencil_vector_type<
      I, N, symphas::lib::types_list<mul_result_t<Es, E>...>>{};
}
...
struct op_void_list<symphas::lib::types_list<E0, Es...>> {
  using type =
      symphas::lib::types_list<OpVoid, std::conditional_t<true, OpVoid, Es>...>;
};

template <>
struct op_void_list<symphas::lib::types_list<>> {
  using type = symphas::lib::types_list<>;
};
}  // namespace symphas::internal

template <size_t I, size_t N, typename T>
expr::stencil_vector_type<I, N,
                          typename symphas::internal::op_void_list<T>::type>
operator*(expr::stencil_vector_type<I, N, T>, OpVoid) {
  return {};
}

template <size_t I, size_t N, typename T>
expr::stencil_vector_type<I, N, T> operator*(expr::stencil_vector_type<I, N, T>,
                                             OpIdentity) {
  return {};
}

template <typename... Ts>
auto infer_list(Ts const&...) {
  return symphas::lib::types_list<Ts...>{};
}

template <size_t I, size_t N, typename... Ts>
auto infer_stencil_vector(Ts const&...) {
  return expr::stencil_vector_type<I, N, symphas::lib::types_list<Ts...>>{};
}

template <typename T, typename E>
struct stencil_mul_result;

template <size_t I, size_t N, typename... Ts>
struct stencil_mul_result<
    expr::stencil_vector_type<I, N, symphas::lib::types_list<Ts...>>, OpVoid> {
  using type = expr::stencil_vector_type<
      I, N, symphas::lib::types_list<std::conditional_t<true, OpVoid, Ts>...>>;
};

template <size_t I, size_t N, typename... Ts>
struct stencil_mul_result<
    expr::stencil_vector_type<I, N, symphas::lib::types_list<Ts...>>,
    OpIdentity> {
  using type = expr::stencil_vector_type<I, N, symphas::lib::types_list<Ts...>>;
};

template <size_t I, size_t N, typename... Ts, typename T>
struct stencil_mul_result<
    expr::stencil_vector_type<I, N, symphas::lib::types_list<Ts...>>, T> {
  using type = expr::stencil_vector_type<
      I, N, symphas::lib::types_list<mul_result_t<Ts, T>...>>;
};

template <typename... E1s, typename... E2s>
struct stencil_mul_result<
    expr::stencil_vector_type<0, 0, symphas::lib::types_list<E1s...>>,
    expr::stencil_vector_type<0, 1, symphas::lib::types_list<E2s...>>> {
  using type = expr::stencil_vector_type<
      1, 0,
      symphas::lib::types_list<typename stencil_mul_result<
          expr::stencil_vector_type<0, 0, symphas::lib::types_list<E1s...>>,
          E2s>::type...>>;
};
...
template <typename... E1s, typename... E2s>
struct stencil_mul_result<
    expr::stencil_vector_type<1, 0, symphas::lib::types_list<E1s...>>,
    expr::stencil_vector_type<0, 2, symphas::lib::types_list<E2s...>>> {
  using type = expr::stencil_vector_type<
      2, 0,
      symphas::lib::types_list<typename stencil_mul_result<
          expr::stencil_vector_type<1, 0, symphas::lib::types_list<E1s...>>,
...
template <typename T, typename E>
using stencil_mul_result_t = typename stencil_mul_result<T, E>::type;
//
// template <typename T1, typename T2>
// auto mul_stencils(expr::stencil_vector_type<0, 0, T1>,
//                  expr::stencil_vector_type<0, 1, T2>) {
//  return stencil_mul_result_t<expr::stencil_vector_type<0, 0, T1>,
//                              expr::stencil_vector_type<0, 1, T2>>{};
//}
//
// template <typename T, typename... E1s>
// auto mul_stencils(
//    expr::stencil_vector_type<1, 0, T>,
//    expr::stencil_vector_type<0, 2, symphas::lib::types_list<E1s...>>) {
//  return infer_stencil_vector<2, 0>(
//      stencil_mul_result_t<expr::stencil_vector_type<1, 0, T>, E1s>{}...);
//}

template <size_t I1, size_t N1, size_t I2, size_t N2, typename T1, typename T2>
auto operator*(expr::stencil_vector_type<I1, N1, T1>,
               expr::stencil_vector_type<I2, N2, T2>) {
  return stencil_mul_result_t<expr::stencil_vector_type<I1, N1, T1>,
                              expr::stencil_vector_type<I2, N2, T2>>{};
}
...
struct stencil_vector_entry_impl<false, N, I,
                                 OpTerms<V, Term<G0, 1>, Term<Gs, 1>...>> {
  using type = OpTerms<typename stencil_vector_entry_impl<false, N, I, V>::type,
                       Term<G0, expr::Xk<N - I>>, Term<Gs, expr::Xk<N - I>>...>;
};

template <size_t N, typename V, typename G0, typename... Gs>
struct stencil_vector_entry_impl<true, N, N,
                                 OpTerms<V, Term<G0, 1>, Term<Gs, 1>...>> {
  using type = typename stencil_vector_entry_impl<true, N, N, V>::type;
};

template <size_t N, size_t I, typename E>
using stencil_vector_entry =
    typename stencil_vector_entry_impl<N == I, N, I, E>::type;

template <typename E, size_t... Is>
auto stencil_vector(expr::symbols::x, E, std::index_sequence<Is...>) {
  return stencil_vector_type<0, 0,
                             symphas::lib::types_list<stencil_vector_entry<
                                 sizeof...(Is) - 1, Is, E>...>>{};
}

template <typename E, size_t... Is>
auto stencil_vector(expr::symbols::y, E, std::index_sequence<Is...>) {
  return stencil_vector_type<0, 1,
                             symphas::lib::types_list<stencil_vector_entry<
                                 sizeof...(Is) - 1, Is, E>...>>{};
}
...
auto stencil_vector(expr::symbols::z, E, std::index_sequence<Is...>) {
  return stencil_vector_type<0, 2,
                             symphas::lib::types_list<stencil_vector_entry<
                                 sizeof...(Is) - 1, Is, E>...>>{};
}
...
struct empty_stencil_vector_type<
    I0, expr::stencil_vector_type<0, I, symphas::lib::types_list<Es...>>,
    std::index_sequence<Is...>> {
  using type = expr::stencil_vector_type<
      0, I, symphas::lib::types_list<std::conditional_t<true, OpVoid, Es>...>>;
};

template <int I0, size_t N, int I, typename... E0s, typename... Es,
          size_t... Is>
struct empty_stencil_vector_type<
    I0,
    expr::stencil_vector_type<
        ...
        symphas::lib::types_list<
            expr::stencil_vector_type<N - 1, I,
                                      symphas::lib::types_list<E0s...>>,
            Es...>>,
    std::index_sequence<Is...>> {
  using empties_t = typename empty_stencil_vector_type<
      I0, expr::stencil_vector_type<N - 1, I, symphas::lib::types_list<E0s...>>,
      std::make_index_sequence<sizeof...(E0s)>>::type;

  using type = expr::stencil_vector_type<
      N, I,
      symphas::lib::types_list<empties_t,
                               symphas::type_ignore_type<Es, empties_t>...>>;
};

template <int I0, size_t N, typename T>
using empty_stencil_vector_t =
    typename empty_stencil_vector_type<I0, T,
...
// auto fill_stencil_vector(expr::stencil_vector_type<1, I,
// symphas::lib::types_list<stencil_vector_type<0, 0, Es>...>>,
// std::index_sequence<Is...>, std::index_sequence<Ns...>)
//{
//	using empty_t = stencil_vector_type<0, 0,
// symphas::lib::types_list<symphas::type_ignore_index<Ns, OpVoid>...>>;
// return expr::stencil_vector_type<1, I,
// symphas::lib::types_list<stencil_vector_type<0, 0, Es>...,
//		symphas::type_ignore_index<Is, empty_t>...>>{};
// }
...
//{
//	constexpr size_t N =
// symphas::lib::types_list_size<symphas::lib::type_at_index<0, Es...>>::value;
//	return fill_stencil_vector(expr::stencil_vector_type<1, I,
// symphas::lib::types_list<stencil_vector_type<0, 0, Es>...>>{},
// std::index_sequence<Is...>{}, std::make_index_sequence<N>{});
// }

// template<size_t I, typename... Es, size_t... Is, typename T0, typename... Ts>
// auto fill_stencil_vector(expr::stencil_vector_type<2, I,
// symphas::lib::types_list<stencil_vector_type<1, I, Es>...>>, T0, Ts...)
//{
//	return expr::stencil_vector_type<1, I,
// symphas::lib::types_list<stencil_vector_type<0, 0, Es>..., Ts...>>{};
// }

template <size_t N, size_t I, typename... Es, size_t... Is>
auto fill_stencil_vector(
    expr::stencil_vector_type<
        N, I, symphas::lib::types_list<stencil_vector_type<N - 1, I, Es>...>>,
    std::index_sequence<Is...>) {
  using E0 =
      symphas::lib::type_at_index<0, stencil_vector_type<N - 1, I, Es>...>;
  return expr::stencil_vector_type<
      N, I,
      symphas::lib::types_list<
          stencil_vector_type<N - 1, I, Es>...,
          empty_stencil_vector_t<Is, sizeof...(Is), E0>...>>{};
}

template <typename V, expr::exp_key_t X, size_t... N0s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::x_symbol, X>>,
                            std::index_sequence<N0s...>) {
  constexpr size_t N = expr::_Xk_t<X>::N;
  return stencil_vector_type<
      0, 0,
      symphas::lib::types_list<std::conditional_t<N == N0s, V, OpVoid>...>>{};
}

template <typename V, expr::exp_key_t X, size_t... N0s, size_t... N1s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::x_symbol, X>>,
                            std::index_sequence<N0s...>,
                            std::index_sequence<0, N1s...>) {
  constexpr size_t N = expr::_Xk_t<X>::N;
  return stencil_vector_type<0, 0,
                             symphas::lib::types_list<std::conditional_t<
                                 (N0s == N), V, OpVoid>...>>{} *
         stencil_vector_type<
             0, 1,
             symphas::lib::types_list<
                 OpIdentity, std::conditional_t<
                                 true, OpVoid, std::index_sequence<N1s>>...>>{};
}

template <typename V, expr::exp_key_t X, size_t... N0s, size_t... N1s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::y_symbol, X>>,
                            std::index_sequence<0, N0s...>,
  ...
  return stencil_vector_type<
             ...
             symphas::lib::types_list<
                 OpIdentity,
                 std::conditional_t<true, OpVoid,
                                    std::index_sequence<N0s>>...>>{} *
         stencil_vector_type<0, 1,
                             symphas::lib::types_list<
                                 std::conditional_t<N == N1s, V, OpVoid>...>>{};
}

template <typename V, expr::exp_key_t X0, expr::exp_key_t X1, size_t... N0s,
          size_t... N1s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::y_symbol, X1>,
                                    Term<expr::symbols::x_symbol, X0>>,
                            std::index_sequence<0, N0s...>,
                            std::index_sequence<0, N1s...>) {
  ...
  return stencil_vector_type<
             ...
             symphas::lib::types_list<
                 OpVoid,
                 std::conditional_t<N0 == N0s, OpIdentity, OpVoid>...>>{} *
         stencil_vector_type<
             0, 1,
             symphas::lib::types_list<
                 OpVoid, std::conditional_t<N1 == N1s, V, OpVoid>...>>{};
}

template <typename V, expr::exp_key_t X0, expr::exp_key_t X1, size_t... N0s,
          size_t... N1s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::x_symbol, X0>,
                                    Term<expr::symbols::y_symbol, X1>>,
                            std::index_sequence<0, N0s...>,
                            std::index_sequence<0, N1s...>) {
  constexpr size_t N0 = expr::_Xk_t<X0>::N;
  constexpr size_t N1 = expr::_Xk_t<X1>::N;
...
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::x_symbol, X>>,
  ...
  return (stencil_vector_type<0, 0,
          ...
          stencil_vector_type<
              0, 1,
              symphas::lib::types_list<
                  OpIdentity, symphas::type_ignore_index<N1s, OpVoid>...>>{}) *
         stencil_vector_type<
             0, 2,
             symphas::lib::types_list<
                 OpIdentity, symphas::type_ignore_index<N2s, OpVoid>...>>{};
}
...
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::y_symbol, X>>,
  ...
  return (stencil_vector_type<
              0, 0,
              symphas::lib::types_list<
                  OpIdentity, symphas::type_ignore_index<N0s, OpVoid>...>>{} *
          stencil_vector_type<0, 1,
                              symphas::lib::types_list<std::conditional_t<
                                  N == N1s, V, OpVoid>...>>{}) *
         stencil_vector_type<
...
template <typename V, expr::exp_key_t X, size_t... N0s, size_t... N1s,
          size_t... N2s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::z_symbol, X>>,
                            std::index_sequence<0, N0s...>,
                            std::index_sequence<0, N1s...>,
  ...
  return (stencil_vector_type<
          ...
          stencil_vector_type<
              ...
              symphas::lib::types_list<
                  OpIdentity, symphas::type_ignore_index<N1s, OpVoid>...>>{}) *
         stencil_vector_type<0, 2,
                             symphas::lib::types_list<
                                 std::conditional_t<N == N2s, V, OpVoid>...>>{};
}

template <typename V, expr::exp_key_t X0, expr::exp_key_t X1, size_t... N0s,
          size_t... N1s, size_t... N2s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::x_symbol, X0>,
                                    Term<expr::symbols::y_symbol, X1>>,
                            std::index_sequence<0, N0s...>,
                            std::index_sequence<0, N1s...>,
...
template <typename V, expr::exp_key_t X0, expr::exp_key_t X2, size_t... N0s,
          size_t... N1s, size_t... N2s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::x_symbol, X0>,
                                    Term<expr::symbols::z_symbol, X2>>,
                            std::index_sequence<0, N0s...>,
                            std::index_sequence<N1s...>,
                            std::index_sequence<0, N2s...>) {
  constexpr size_t N0 = expr::_Xk_t<X0>::N;
  ...
  return (stencil_vector_type<
         ...
         stencil_vector_type<
             0, 2,
             symphas::lib::types_list<
                 OpVoid, std::conditional_t<N2 == N2s, V, OpVoid>...>>{};
}

template <typename V, expr::exp_key_t X0, expr::exp_key_t X2, size_t... N0s,
          size_t... N1s, size_t... N2s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::z_symbol, X2>,
                                    Term<expr::symbols::x_symbol, X0>>,
                            std::index_sequence<0, N0s...>,
                            std::index_sequence<N1s...>,
                            std::index_sequence<0, N2s...>) {
...
template <typename V, expr::exp_key_t X1, expr::exp_key_t X2, size_t... N0s,
          size_t... N1s, size_t... N2s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::y_symbol, X1>,
                                    Term<expr::symbols::z_symbol, X2>>,
                            std::index_sequence<0, N0s...>,
  ...
  return (stencil_vector_type<
          ...
          stencil_vector_type<
              ...
              symphas::lib::types_list<
                  OpVoid,
                  std::conditional_t<N1 == N1s, OpIdentity, OpVoid>...>>{}) *
         stencil_vector_type<
             0, 2,
             symphas::lib::types_list<
                 OpVoid, std::conditional_t<N2 == N2s, V, OpVoid>...>>{};
...
template <typename V, expr::exp_key_t X0, expr::exp_key_t X1,
          expr::exp_key_t X2, size_t... N0s, size_t... N1s, size_t... N2s>
auto as_stencil_vector_impl(OpTerms<V, Term<expr::symbols::x_symbol, X0>,
                                    Term<expr::symbols::y_symbol, X1>,
                                    Term<expr::symbols::z_symbol, X2>>,
                            std::index_sequence<0, N0s...>,
...
auto as_stencil_vector_impl(OpVoid, std::index_sequence<N0s...>,
  ...
  return stencil_vector_type<
             0, 0,
             symphas::lib::types_list<
                 symphas::type_ignore_index<N0s, OpVoid>...>>{} *
         stencil_vector_type<0, 1,
                             symphas::lib::types_list<
                                 symphas::type_ignore_index<N1s, OpVoid>...>>{};
}
...
auto unpack_stencil_vector(
  ...
  return std::make_tuple(
      unpack_stencil_vector(stencil_vector_type<0, 0, Es>{})...);
}
...
auto unpack_stencil_vector(
    expr::stencil_vector_type<
        2, I, symphas::lib::types_list<stencil_vector_type<1, 0, Es>...>>) {
  return std::make_tuple(
      unpack_stencil_vector(stencil_vector_type<1, 0, Es>{})...);
}
...
struct filter_zeros<symphas::lib::types_list<Ts...>> {
  using type =
      symphas::lib::expand_types_list<typename filter_zeros<Ts>::type...>;
};
...
struct filter_zeros<
  ...
  using type = symphas::lib::expand_types_list<
      typename filter_zeros<symphas::lib::types_list<Es...>>::type>;
};
...
// template <size_t I, size_t N, typename... Es, typename E>
// auto operator*(expr::stencil_vector_type<I, N,
...
//   return expr::stencil_vector_type<
//       I, N,
//       symphas::lib::types_list<symphas::type_ignore_type<Es, OpVoid>...>>{};
// }
...
// auto operator*(
//     expr::stencil_vector_type<0, 0, symphas::lib::types_list<E0s...>>,
//     expr::stencil_vector_type<0, 1, symphas::lib::types_list<E1s...>>) {
//   return expr::stencil_vector_type<
//       1, 0,
//       symphas::lib::types_list<mul_result_t<
//           expr::stencil_vector_type<0, 0, symphas::lib::types_list<E0s...>>,
//           E1s>...>>{};
// }
...
// template <typename... E0s, typename... E1s>
// auto operator*(
//     expr::stencil_vector_type<1, 0, symphas::lib::types_list<E0s...>>,
//     expr::stencil_vector_type<0, 2, symphas::lib::types_list<E1s...>>) {
//   return expr::stencil_vector_type<
//       2, 0,
//       symphas::lib::types_list<mul_result_t<
...
auto operator+(
  ...
  if constexpr (sizeof...(E0s) == sizeof...(E1s)) {
    // auto test0 = unpack_stencil_vector(expr::stencil_vector_type<N, I,
    // symphas::lib::types_list<E0s...>>{}); auto test1 =
    // unpack_stencil_vector(expr::stencil_vector_type<N, I,
    // symphas::lib::types_list<E1s...>>{}); auto test =
    // unpack_stencil_vector(expr::stencil_vector_type<N, I,
    // symphas::lib::types_list<add_result_t<E0s, E1s>...>>{});
    return expr::stencil_vector_type<
        N, I, symphas::lib::types_list<add_result_t<E0s, E1s>...>>{};
  } else if constexpr (sizeof...(E0s) < sizeof...(E1s)) {
    return expr::fill_stencil_vector(
               expr::stencil_vector_type<N, I,
                                         symphas::lib::types_list<E0s...>>{},
...
auto operator-(
  ...
  if constexpr (sizeof...(E0s) == sizeof...(E1s)) {
    return expr::stencil_vector_type<
        N, I, symphas::lib::types_list<sub_result_t<E0s, E1s>...>>{};
  } else if constexpr (sizeof...(E0s) < sizeof...(E1s)) {
    return expr::fill_stencil_vector(
               expr::stencil_vector_type<N, I,
                                         symphas::lib::types_list<E0s...>>{},
...
auto setup_stencil_equation(
    types_list<std::pair<expr::symbols::internal::S2_symbol<Is, Js>, Es>...>,
    E const& d_op) {
  using namespace expr::symbols;
  return ((Es{} *
           expr::stencil_vector(x{}, expr::make_integer<Is>() * h{},
                                std::make_index_sequence<K + 1>{}) *
           expr::stencil_vector(y{}, expr::make_integer<Js>() * h{},
                                std::make_index_sequence<L + 1>{})) +
          ...) +
         expr::as_stencil_vector(
             -expr::apply_operators(d_op *
                                    (expr::pow<K>(x{}) * expr::pow<L>(y{}))),
             std::index_sequence<K + 1, L + 1>{});

  // return ((Es{} * expr::pow<K>(x{} + expr::make_integer<Is>() * h{}) *
  // expr::pow<L>(y{} + expr::make_integer<Js>() * h{})) + ...)
  //	- expr::apply_operators(d_op * (expr::pow<K>(x{}) * expr::pow<L>(y{})));
}

template <size_t K, size_t L, size_t M, int... Is, int... Js, int... Ks,
          typename... Es, typename E>
auto setup_stencil_equation(
    types_list<
  ...
  return ((Es{} *
           (expr::stencil_vector(x{}, expr::make_integer<Is>() * h{},
            ...
            expr::stencil_vector(y{}, expr::make_integer<Js>() * h{},
                                 std::make_index_sequence<L + 1>{})) *
           expr::stencil_vector(z{}, expr::make_integer<Ks>() * h{},
                                std::make_index_sequence<M + 1>{})) +
          ...) +
         expr::as_stencil_vector(
             -expr::apply_operators(
                 d_op *
                 (expr::pow<K>(x{}) * expr::pow<L>(y{}) * expr::pow<M>(z{}))),
             std::index_sequence<K + 1, L + 1, M + 1>{});

  // return ((Es{} * expr::pow<K>(x{} + expr::make_integer<Is>() * h{}) *
  // expr::pow<L>(y{} + expr::make_integer<Js>() * h{}) * expr::pow<M>(z{} +
  // expr::make_integer<Ks>() * h{})) + ...)
  //	- expr::apply_operators(d_op * (expr::pow<K>(x{}) * expr::pow<L>(y{}) *
  // expr::pow<M>(z{})));
}
...
// *************************************************************************************************
// Simplifies a stencil dictionary based on the symmetry of a central difference
// operator. In particular, for even-ordered derivatives, applies "rotational"
// symmetry, and for odd-ordered derivatives, makes the right side equal to the
// negative of the left side.
// *************************************************************************************************
...
auto simplify_central_stencils(
    types_list<std::pair<
        expr::symbols::internal::S1_symbol<Is>,
        OpTerm<OpIdentity, expr::symbols::internal::S1_symbol<Is>>>...> const&
        dict) {
  using expression_first_half_t = types_between_index<
      0, sizeof...(Is) / 2,
      OpTerm<OpIdentity, expr::symbols::internal::S1_symbol<Is>>...>;
  using expression_at_half_t = type_at_index<
      sizeof...(Is) / 2,
      OpTerm<OpIdentity, expr::symbols::internal::S1_symbol<Is>>...>;
  ...
  if constexpr (O == 0) {
    ...
    return typename pack_dictionary<
        expand_types_list<expression_first_half_t,
                          types_list<expression_at_half_t>,
                          reverse_types_list<expression_first_half_t>>,
        std::integer_sequence<int, Is...>>::type{};
  } else if constexpr (O % 2 == 1) {
    return typename pack_dictionary<
        expand_types_list<expression_first_half_t, types_list<OpVoid>,
                          decltype(neg_elements(
                              reverse_types_list<expression_first_half_t>{}))>,
        std::integer_sequence<int, Is...>>::type{};
  }
}
...
auto simplify_central_stencils(
    types_list<std::pair<expr::symbols::internal::S2_symbol<Is, Js>,
                         OpTerm<OpIdentity, expr::symbols::internal::S2_symbol<
                                                Is, Js>>>...> const& dict) {
...
auto simplify_central_mixed_stencils(
    types_list<std::pair<expr::symbols::internal::S2_symbol<Is, Js>,
                         Es>...> const& dict) {
  ...
  if constexpr (Oy == 0) {
    ...
    using nTs =
        types_list<std::invoke_result_t<decltype(&neg_one_element<Es>), Es>...>;

    return typename pack_dictionary<
        types_list<std::conditional_t<
            ((Js != 0 && test_in_radius<RJ_2, Is, Js>) ||
             (!test_in_radius<R / 2, Is, Js> &&
              test_in_radius<R / 2 + 1, Is, Js>)),
            typename at_stencil_index_2d<
                Is, -fixed_abs<Js>, std::conditional_t<(Js < 0), Ts, nTs>,
                std::integer_sequence<int, Is...>,
                std::integer_sequence<int, Js...>>::type,
            OpVoid>...>,
        std::integer_sequence<int, Is...>,
    ...
    return typename pack_dictionary<
        types_list<std::conditional_t<
            ((test_in_radius<RJ_2 - NEG_RADIUS_CENTRAL_2D, Is, Js> ||
              fixed_abs<Js> == fixed_abs<Is>)),
            typename at_stencil_index_2d<
                (Is != 0 && Js != 0)
                    ? fixed_sign<Is> * fixed_min<fixed_abs<Js>, fixed_abs<Is>>
                    : Is,
                (Is != 0 && Js != 0) ? -fixed_max<fixed_abs<Is>, fixed_abs<Js>>
                                     : -fixed_abs<Js>,
                types_list<Es...>, std::integer_sequence<int, Is...>,
                std::integer_sequence<int, Js...>>::type,
            OpVoid>...>,
        std::integer_sequence<int, Is...>,
        std::integer_sequence<int, Js...>>::type{};
...
auto simplify_central_mixed_stencils(
  ...
  if constexpr (Ox == 0) {
    using dictx = typename pack_dictionary<
        types_list<
            std::conditional_t<(test_in_radius<RI_2 - 1, Is>), Es, OpVoid>...>,
        std::integer_sequence<int, Is...>,
        std::integer_sequence<int, Js...>>::type;
    ...
    using dictx = typename pack_dictionary<
        types_list<std::conditional_t<
            ((Is != 0 && test_in_radius<RI_2, Is, Js>) ||
             (!test_in_radius<R / 2, Is, Js> &&
              test_in_radius<R / 2 + 1, Is, Js>)),
            typename at_stencil_index_2d<
                -fixed_abs<Is>, Js, std::conditional_t<(Is < 0), Ts, nTs>,
                std::integer_sequence<int, Is...>,
                std::integer_sequence<int, Js...>>::type,
            OpVoid>...>,
        std::integer_sequence<int, Is...>,
    ...
    using dictx = typename pack_dictionary<
        types_list<std::conditional_t<
            ((test_in_radius<RI_2 - NEG_RADIUS_CENTRAL_2D, Is, Js> ||
              fixed_abs<Js> == fixed_abs<Is>)),
            typename at_stencil_index_2d<
                (Is != 0 && Js != 0) ? -fixed_max<fixed_abs<Js>, fixed_abs<Is>>
                                     : -fixed_abs<Is>,
                (Is != 0 && Js != 0)
                    ? fixed_sign<Js> * fixed_min<fixed_abs<Js>, fixed_abs<Is>>
                    : Js,
                types_list<Es...>, std::integer_sequence<int, Is...>,
                std::integer_sequence<int, Js...>>::type,
            OpVoid>...>,
...
auto simplify_central_mixed_stencils(
  ...
  if constexpr (Oz == 0) {
    ...
    return typename pack_dictionary<
        types_list<std::conditional_t<
            ((Ks != 0 && test_in_radius<RK_2, Ks>) ||
             !test_in_radius<R / 2, Is, Js, Ks>),
            typename at_stencil_index_3d<
                Is, Js, -fixed_abs<Ks>, std::conditional_t<(Ks < 0), Ts, nTs>,
                std::integer_sequence<int, Is...>,
                std::integer_sequence<int, Js...>,
                std::integer_sequence<int, Ks...>>::type,
            OpVoid>...>,
    ...
    return typename pack_dictionary<
        types_list<std::conditional_t<
            ((test_in_radius<R / 2 - 1 - NEG_RADIUS_CENTRAL_3D, Is, Js, Ks> ||
              fixed_abs<Ks> == fixed_abs<Js> ||
              fixed_abs<Ks> == fixed_abs<Is>)),
            typename at_stencil_index_3d<
                Is, Js, -fixed_abs<Ks>, types_list<Es...>,
                std::integer_sequence<int, Is...>,
                std::integer_sequence<int, Js...>,
                std::integer_sequence<int, Ks...>>::type,
            OpVoid>...>,
...
template <size_t Oy, size_t Oz, size_t N, int... Is, int... Js, int... Ks,
          typename... Es>
auto simplify_central_mixed_stencils(
    types_list<std::pair<expr::symbols::internal::S3_symbol<Is, Js, Ks>,
                         Es>...> const& dict) {
  ...
  if constexpr (Oy == 0) {
    using dicty = typename pack_dictionary<
        types_list<
            std::conditional_t<(test_in_radius<RJ_2 - 1, Js>), Es, OpVoid>...>,
        std::integer_sequence<int, Is...>, std::integer_sequence<int, Js...>,
        std::integer_sequence<int, Ks...>>::type;
    ...
    using dicty = typename pack_dictionary<
        types_list<std::conditional_t<
            ((Js != 0 && test_in_radius<RJ_2, Js>) ||
             !test_in_radius<R / 2, Is, Js, Ks>),
            typename at_stencil_index_3d<
                Is, -fixed_abs<Js>, Ks, std::conditional_t<(Js < 0), Ts, nTs>,
                std::integer_sequence<int, Is...>,
                std::integer_sequence<int, Js...>,
                std::integer_sequence<int, Ks...>>::type,
            OpVoid>...>,
    ...
    using dicty = typename pack_dictionary<
        types_list<std::conditional_t<
            ((test_in_radius<R / 2 - 1 - NEG_RADIUS_CENTRAL_3D, Is, Js, Ks> ||
              fixed_abs<Js> == fixed_abs<Is> ||
              fixed_abs<Js> == fixed_abs<Ks>)),
            typename at_stencil_index_3d<
                Is, -fixed_abs<Js>, Ks, types_list<Es...>,
                std::integer_sequence<int, Is...>,
                std::integer_sequence<int, Js...>,
                std::integer_sequence<int, Ks...>>::type,
            OpVoid>...>,
...
template <size_t Ox, size_t Oy, size_t Oz, size_t N, int... Is, int... Js,
          int... Ks, typename... Es>
auto simplify_central_mixed_stencils(
    types_list<std::pair<expr::symbols::internal::S3_symbol<Is, Js, Ks>,
                         Es>...> const& dict) {
  ...
  if constexpr (Ox == 0) {
    ...
    using dictx = typename pack_dictionary<
        types_list<std::conditional_t<
            ((Is != 0 && test_in_radius<RI_2, Is>) ||
             !test_in_radius<R / 2, Is, Js, Ks>),
            typename at_stencil_index_3d<
                -fixed_abs<Is>, Js, Ks, std::conditional_t<(Is < 0), Ts, nTs>,
                std::integer_sequence<int, Is...>,
                std::integer_sequence<int, Js...>,
                std::integer_sequence<int, Ks...>>::type,
            OpVoid>...>,
    ...
    using dictx = typename pack_dictionary<
        types_list<std::conditional_t<
            ((test_in_radius<R / 2 - 1 - NEG_RADIUS_CENTRAL_3D, Is, Js, Ks> ||
              fixed_abs<Is> == fixed_abs<Js> ||
              fixed_abs<Is> == fixed_abs<Ks>)),
            typename at_stencil_index_3d<
                -fixed_abs<Is>, Js, Ks, types_list<Es...>,
                std::integer_sequence<int, Is...>,
                std::integer_sequence<int, Js...>,
                std::integer_sequence<int, Ks...>>::type,
            OpVoid>...>,
...
// *************************************************************************************************
// `update_stencil_dictionary`: updates the dictionary of stencil coefficients
// using equations generated from the equation setup phase.
// `update_stencil_dictionary` is applied for every equation that it is passed.
// On each pass, the given equation has substitutions made, and then the
// dictionary is updated by isolating for the first unknown symbol. The updated
// dictionary is used on subsequent calls.
// *************************************************************************************************
...
struct symbol_match<N,
                    types_list<expr::symbols::internal::S1_symbol<I>, Ts...>> {
  static const size_t value = N;
};

template <size_t N, typename... Ts, int I, int J>
struct symbol_match<
    N, types_list<expr::symbols::internal::S2_symbol<I, J>, Ts...>> {
  static const size_t value = N;
};

template <size_t N, typename... Ts, int I, int J, int K>
struct symbol_match<
    N, types_list<expr::symbols::internal::S3_symbol<I, J, K>, Ts...>> {
  static const size_t value = N;
};
...
auto update_stencil_dictionary(
    types_list<std::pair<Symbols, Es>...> const& dict, OpVoid) {
  return dict;
}

template <typename... Symbols, typename... Es,
          typename E0>  //, typename F =
                        // first_undefined_symbol<types_list<std::pair<Symbols,
                        // Es>...>>>
auto update_stencil_dictionary(
    types_list<std::pair<Symbols, Es>...> const& dict,
    OpExpression<E0> const& expr) {
...
// auto
// update_stencil_dictionary(types_list<std::pair<expr::symbols::internal::S3_symbol<Is,
// Js, Ks>, Es>...> const& dict, types_list<> const& exprs)
//{
//	return typename pack_dictionary<types_list<Es...>,
// std::integer_sequence<int, Is...>, std::integer_sequence<int, Js...>,
// std::integer_sequence<int, Ks...>>::type{};
// }
...
// template<int... Is, int... Js, typename... Es>
// auto
// update_stencil_dictionary(types_list<std::pair<expr::symbols::internal::S2_symbol<Is,
// Js>, Es>...> const& dict, types_list<> const& exprs)
//{
//	return typename pack_dictionary<types_list<Es...>,
// std::integer_sequence<int, Is...>, std::integer_sequence<int,
// Js...>>::type{};
// }

// template<int... Is, typename... Es>
// auto
// update_stencil_dictionary(types_list<std::pair<expr::symbols::internal::S1_symbol<Is>,
// Es>...> const& dict, types_list<> const& exprs)
//{
//	return typename pack_dictionary<types_list<Es...>,
// std::integer_sequence<int, Is...>>::type{};
// }
...
auto update_stencil_dictionary(
    types_list<std::pair<Symbols, Es>...> const& dict,
    types_list<OpVoid, E0s...> const& exprs) {
...
// auto update_stencil_dictionary(types_list<std::pair<Symbols, Es>...> const&
// dict, 	stencil_vector_type<N, 0,
// symphas::lib::types_list<stencil_vector_type<N - 1, 0, E0s>...>>)
//{
//	return update_stencil_dictionary(dict,
// symphas::lib::types_list<stencil_vector_type<N - 1, 0, E0s>...>{});
// }
...
template <size_t Q, size_t P, size_t L, int... Is, int... Js, int... Ks,
          typename... Es, typename E>
auto setup_stencil_equation_permute(
    types_list<std::pair<expr::symbols::internal::S3_symbol<Is, Js, Ks>,
                         Es>...> const& dict,
    E const& d_op) {
  return types_list<decltype(expr::setup_stencil_equation<Q, P, L>(dict, d_op)),
                    decltype(expr::setup_stencil_equation<L, Q, P>(dict, d_op)),
                    decltype(expr::setup_stencil_equation<P, L, Q>(dict,
                                                                   d_op))>{};
}

template <size_t Q0, size_t Q, size_t P, size_t L, int... Is, int... Js,
          int... Ks, typename... Es, typename E>
auto setup_stencil_equation_expand_2(
    types_list<std::pair<expr::symbols::internal::S3_symbol<Is, Js, Ks>,
                         Es>...> const& dict,
    E const& d_op) {
  if constexpr (Q == Q0 / 2 && Q0 % 2 == 0 && Q > 2) {
    return types_list<>{};
  } else {
...
template <size_t Q0, size_t Q, size_t P, size_t... Ps, int... Is, int... Js,
          int... Ks, typename... Es, typename E>
auto setup_stencil_equation_expand_1(
  ...
  auto t = std::make_tuple(
      setup_stencil_equation_expand_2<Q0, Q, P - Ps, Ps>(dict, d_op)...);
  return expand_types_list<decltype(setup_stencil_equation_expand_2<
                                    Q0, Q, P - Ps, Ps>(dict, d_op))...>{};
}
...
//! Separates a list of equations based on the order of the x and y variables.
template <size_t Q, int R, int... Is, int... Js, int... Ks, typename... Es,
          size_t... Ls, typename E>
auto setup_stencil_equation_list(
    types_list<std::pair<expr::symbols::internal::S3_symbol<Is, Js, Ks>,
                         Es>...> const& dict,
    E const& d_op, std::index_sequence<Ls...>) {
  ...
  // auto exprs =
  // std::make_tuple(expr::unpack_stencil_vector(symphas::internal::setup_stencil_equation_expand_1<Q,
  // Q - Ls, Ls>(dict, d_op, std::make_index_sequence<Ls>{}))...);
  auto t = std::make_tuple(setup_stencil_equation_expand_1<Q, Q - Ls, Ls>(
      dict, d_op, std::make_index_sequence<Ls>{})...);
  using expr_types =
      types_list<decltype(symphas::internal::setup_stencil_equation_expand_1<
                          Q, Q - Ls, Ls>(dict, d_op,
                                         std::make_index_sequence<Ls>{}))...>;
  return symphas::internal::filter_zeros_t<expr_types>{};
}

// *************************************************************************************************
// `get_central_space_stencil`: entry point for setting up the equations and
// recursively updating the dictionary based on those equations.
// *************************************************************************************************

template <size_t Q, size_t N, int R, int... Is, typename... Es, typename E,
          size_t O = expr::derivative_order<E>::value>
auto construct_stencil(
    types_list<std::pair<expr::symbols::internal::S1_symbol<Is>, Es>...> const&
        dict,
    E const& d_op) {
  // expr::printe(setup_stencil_equation_<Q>(dict, d_op));
  // auto terms = expr::unpack_stencil_vector(setup_stencil_equation<Q>(dict,
  // d_op));
...
auto construct_stencil(
  ...
  return update_stencil_dictionary(
      dict, setup_stencil_equation_list<Q>(dict, d_op,
                                           std::make_index_sequence<Q>{}));
}

template <size_t Q, size_t N, int R, int... Is, int... Js, int... Ks,
          typename... Es, typename E,
          size_t O = expr::derivative_order<E>::value>
auto construct_stencil(
    types_list<std::pair<expr::symbols::internal::S3_symbol<Is, Js, Ks>,
  ...
  // constexpr size_t QQ = (O % 2 == 0) ? Q / 2 + 1 : Q + 1;
  return update_stencil_dictionary(
      dict, setup_stencil_equation_list<Q, R>(dict, d_op,
                                              std::make_index_sequence<Q>{}));
}

template <size_t O1, size_t O2>
using mixed_deriv_2d_t =
    std::invoke_result_t<decltype(&get_mixed_derivative<O1, O2>)>;

template <int I, int J, size_t O, typename T>
using dict_entry_2d_t =
    std::pair<expr::symbols::internal::S2_symbol<I, J>,
              decltype(T{} / expr::pow<O>(expr::symbols::h{}))>;

// template<size_t N, size_t D, typename E, size_t O =
// expr::derivative_order<E>::value> auto get_central_space_stencil(E const&
// d_op)
//{
...
template <size_t N, size_t D, typename E, typename... Ss,
          size_t O = expr::derivative_order<E>::value>
...
auto get_central_space_stencil() {
  constexpr int R = symphas::internal::R_<O, N>;
  auto dict =
      simplify_central_stencils<O>(make_central_stencil_dictionary<D, R>());

  if constexpr (D == 1) {
    return get_stencil<N, 1>(
        expr::make_operator_derivative<O, expr::symbols::x_symbol>(), dict);
  } else if constexpr (D == 2) {
    if constexpr (O == 1) {
      return get_stencil<N, 2>(
          expr::make_operator_derivative<1, expr::symbols::x_symbol>(), dict);
    }
    if constexpr (O % 2 == 0) {
      return get_stencil<N, 2>(
          expr::pow<O / 2>(
    ...
    if constexpr (O == 1) {
      return get_stencil<N, 3>(
          expr::make_operator_derivative<1, expr::symbols::x>(), dict);
    }
    if constexpr (O % 2 == 0) {
      return get_stencil<N, 3>(
          expr::pow<O / 2>(
...
auto get_central_space_mixed_stencil(std::index_sequence<O1, O2, O3>) {
  ...
  auto dict = simplify_central_mixed_stencils<O1, O2, O3, N>(
      make_central_stencil_dictionary<3, R>());
...
// *************************************************************************************************
// Applies the result of `get_*_stencil` (which is in the form of the stencil
// dictionary) and can either print it or apply it as a stencil to a grid.
// *************************************************************************************************
...
struct StencilCoeff<
  ...
  __host__ __device__ auto operator()(T const* v, len_type const (&stride)[2]) {
    return coeff * v[stride[0] * N0 + stride[1] * N1];
  }
...
struct StencilCoeff<
  ...
  __host__ __device__ auto operator()(T const* v, len_type const (&stride)[3]) {
    return coeff * v[stride[0] * N0 + stride[1] * N1 + stride[2] * N2];
  }
...
template <int Im, int Jm, int I, int I0, int J0, typename E0, int... Is,
          int... Js, typename... Es>
size_t print_stencil(
    types_list<std::pair<expr::symbols::internal::S2_symbol<I0, J0>, E0>,
               std::pair<expr::symbols::internal::S2_symbol<Is, Js>, Es>...>
        content) {
  using entry_t =
      StencilCoeff<std::pair<expr::symbols::internal::S2_symbol<I0, J0>, E0>>;
...
size_t print_stencil(
    types_list<std::pair<expr::symbols::internal::S2_symbol<Is, Js>, Es>...>
        content) {
  return print_stencil<fixed_min<Is...>, fixed_min<Js...>, fixed_min<Is...>>(
      content);
}

template <int... Is, int... Js, typename... Es>
size_t print_stencil(
    GeneratedStencilApply<types_list<
        std::pair<expr::symbols::internal::S2_symbol<Is, Js>, Es>...>>) {
...
struct coeff_type_divh {
  using type = E0;
};
template <>
struct coeff_type_divh<OpVoid> {
  using type = OpVoid;
};
template <typename A, typename B>
struct coeff_type_divh<OpBinaryDiv<A, B>> {
  using type = B;
};
...
struct GeneratedStencilApply<types_list<>> {
  ...
  size_t print(char* out) const { return sprintf(out, "x"); }

  size_t print(FILE* out) const { return fprintf(out, "x"); }
};

template <int... Is, typename... Es>
struct GeneratedStencilApply<
    types_list<std::pair<expr::symbols::internal::S1_symbol<Is>, Es>...>> {
  static const size_t h_exponent = fixed_max<expr::factor_count<
  ...
  __host__ __device__ auto operator()(T const* v, len_type stride,
                                      double divh) const {
    return std::pow(divh, h_exponent) *
           (StencilCoeff<
                std::pair<expr::symbols::internal::S1_symbol<Is>, Es>>{}(
                v, stride) +
            ...);
  }
  ...
  size_t print(char* out) const {
    size_t n = 0;
    (((n +=
       StencilCoeff<std::pair<expr::symbols::internal::S1_symbol<Is>, Es>>{}
           .print(out + n)),
      (n += sprintf(out + n, "\n"))),
     ...);
    return n;
...
struct GeneratedStencilApply<
  ...
  size_t print(char* out) const {
    size_t n = 0;
    (((n +=
       StencilCoeff<std::pair<expr::symbols::internal::S2_symbol<Is, Js>, Es>>{}
           .print(out + n)),
      (n += sprintf(out + n, "\n"))),
     ...);
    return n;
...
struct GeneratedStencilApply<types_list<
  ...
  __host__ __device__ auto operator()(T const* v, len_type const (&stride)[3],
                                      double divh) const {
    return std::pow(divh, h_exponent) *
           (StencilCoeff<std::pair<
                expr::symbols::internal::S3_symbol<Is, Js, Ks>, Es>>{}(v,
                                                                       stride) +
            ...);
  }
