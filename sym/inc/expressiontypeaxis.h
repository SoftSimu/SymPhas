...
struct GridAxis
{
	 ...
	 */
	GridAxis(len_type const (&dims0)[D], len_type const (&dims)[D], double left, double right) :
		GridAxis()
	{
	...
	GridAxis(len_type const (&dims)[D]) :
		GridAxis(dims, dims, 0, 1) {}
...
namespace expr
{
	...
	{
		static auto get(TimeValue const& data, iter_type)
		{
			return data.get_time();
		}
		static auto get(TimeValue const& data)
		{
			return data;
		}
		static auto get(TimeValue& data, iter_type)
		{
			return data.get_time();
		}
		static auto get(TimeValue& data)
		{
			return data;
		}
	};
	...
	struct BaseData<GridAxis<1, Axis::X>>
	{
		...
		static auto get(GridAxis<1, Axis::X> const& data)
		{
			return data;
		}
		...
		static auto get(GridAxis<1, Axis::X>& data)
		{
			return data;
		}
	};
	...
	struct BaseData<GridAxis<2, Axis::X>>
	{
		...
		static auto get(GridAxis<2, Axis::X> const& data)
		{
			return data;
		}
		...
		static auto get(GridAxis<2, Axis::X>& data)
		{
			return data;
		}
	};
	...
	struct BaseData<GridAxis<3, Axis::X>>
	{
		...
		static auto get(GridAxis<3, Axis::X> const& data)
		{
			return data;
		}
		...
		static auto get(GridAxis<3, Axis::X>& data)
		{
			return data;
		}
	};
	...
	struct BaseData<GridAxis<2, Axis::Y>>
	{
		...
		static auto get(GridAxis<2, Axis::Y> const& data)
		{
			return data;
		}
		...
		static auto get(GridAxis<2, Axis::Y>& data)
		{
			return data;
		}
	};
	...
	struct BaseData<GridAxis<3, Axis::Y>>
	{
		...
		static auto get(GridAxis<3, Axis::Y> const& data)
		{
			return data;
		}
		...
		static auto get(GridAxis<3, Axis::Y>& data)
		{
			return data;
		}
	};
	...
	struct BaseData<GridAxis<3, Axis::Z>>
	{
		...
		static auto get(GridAxis<3, Axis::Z> const& data)
		{
			return data;
		}
		...
		static auto get(GridAxis<3, Axis::Z>& data)
		{
			return data;
		}
	};
	 ...
	 */
	inline auto make_varx(len_type dims0, len_type dims, double left, double right)
	{
	...
	template<>
	inline auto make_var<Axis::X, 1>(len_type const* dims0, len_type const* dims, double left, double right)
	{
		return make_varx(dims0[0], dims[0], left, right);
	}

	template<>
	inline auto make_var<Axis::X, 2>(len_type const* dims0, len_type const* dims, double left, double right)
	{
	...
	template<>
	inline auto make_var<Axis::X, 3>(len_type const* dims0, len_type const* dims, double left, double right)
	{
	...
	template<>
	inline auto make_var<Axis::Y, 2>(len_type const* dims0, len_type const* dims, double left, double right)
	{
		len_type dims0_arr[]{ dims0[0], dims0[1] };
		len_type dims_arr[]{ dims[0], dims[1] };
	...
	template<>
	inline auto make_var<Axis::Y, 3>(len_type const* dims0, len_type const* dims, double left, double right)
	{
		len_type dims0_arr[]{ dims0[0], dims0[1], dims0[2] };
		len_type dims_arr[]{ dims[0], dims[1], dims[2] };
		return make_vary(dims0_arr, dims_arr, left, right);
	...
	template<>
	inline auto make_var<Axis::Z, 3>(len_type const* dims0, len_type const* dims, double left, double right)
	{
		len_type dims0_arr[]{ dims0[0], dims0[1], dims0[2] };
		len_type dims_arr[]{ dims[0], dims[1], dims[2] };
