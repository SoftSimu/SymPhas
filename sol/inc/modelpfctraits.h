 ...
 * the recipe is, the pfc model inherits from these classes through the CRTP construct, and
 * these classes expose a function that the pfc model must use to apply various
 * functionalities
 */
 ...
 * it uses expression templates to find the correct parameter for the given field
 */
