...
template <>
void symphas::io::gp::read_block(scalar_t* grid, symphas::io::block_info binfo,
                                 FILE* f) {
...
template <>
void symphas::io::gp::read_block(complex_t* grid, symphas::io::block_info binfo,
                                 FILE* f) {
  auto helper = symphas::io::new_helper(binfo);
...
template <>
void symphas::io::gp::read_block(double_arr2* grid,
...
template <>
void symphas::io::gp::read_block(vector_t<3>* grid,
                                 symphas::io::block_info binfo, FILE* f) {
  auto helper = symphas::io::new_helper(binfo);
...
template <>
void symphas::io::gp::read_block(vector_t<2>* grid,
                                 symphas::io::block_info binfo, FILE* f) {
  auto helper = symphas::io::new_helper(binfo);
  for (iter_type j = 0; j < GP_HELPER_LENY; j++) {
    for (iter_type i = 0; i < GP_HELPER_LENX; i++) {
...
template <>
void symphas::io::gp::read_block(vector_t<1>* grid,
                                 symphas::io::block_info binfo, FILE* f) {
  auto helper = symphas::io::new_helper(binfo);
  for (iter_type i = 0; i < GP_HELPER_LENX; i++) {
    double m;
...
template <>
void symphas::io::gp::read_block(scalar_ptr_t (&grid)[3],
                                 symphas::io::block_info binfo, FILE* f) {
  auto helper = symphas::io::new_helper(binfo);
  for (iter_type k = 0; k < GP_HELPER_LENZ; k++) {
    for (iter_type j = 0; j < GP_HELPER_LENY; j++) {
...
template <>
void symphas::io::gp::read_block(scalar_ptr_t (&grid)[2],
                                 symphas::io::block_info binfo, FILE* f) {
  auto helper = symphas::io::new_helper(binfo);
  for (iter_type j = 0; j < GP_HELPER_LENY; j++) {
    for (iter_type i = 0; i < GP_HELPER_LENX; i++) {
...
template <>
void symphas::io::gp::read_block(scalar_ptr_t (&grid)[1],
                                 symphas::io::block_info binfo, FILE* f) {
  auto helper = symphas::io::new_helper(binfo);
  for (iter_type i = 0; i < GP_HELPER_LENX; i++) {
    double m;
