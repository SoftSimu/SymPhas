...
namespace symphas::lib
{
	 ...
	 */
	inline void make_scalar_values(const complex_t* data, scalar_t* out, size_t len)
	{
		constexpr scalar_t(*abs_f)(const complex_t&) = &std::abs<scalar_t>;
	 ...
	 */
	template<size_t D>
	inline void make_scalar_values(const vector_t<D>* data, scalar_t* out, size_t len)
	{
	 ...
	 * \param len Length of the array pointed to by data.
	 */
	inline void make_scalar_values(const scalar_t* data, scalar_t* out, size_t len)
	{
	 ...
	 */
	template<size_t D>
	inline std::vector<std::pair<axis_nd_t<D>, scalar_t>> to_scalar_field(std::vector<std::pair<axis_nd_t<D>, scalar_t>> const& data)
	{
		return data;
	}
	 ...
	 */
	template<size_t D>
	inline std::vector<std::pair<axis_nd_t<D>, scalar_t>> to_scalar_field(std::vector<std::pair<axis_nd_t<D>, complex_t>> const& data)
	{
