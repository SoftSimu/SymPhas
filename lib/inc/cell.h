...
struct VectorValue
{
	...
	/*!
	 * Operator for computing the dot product of two VectorValue instances. A vector multiplied
	 * with another vector of the same dimensions is assumed to be the dot product. This would
	 * be equivalent of multiplying a row vector by a column vector.
	 *
