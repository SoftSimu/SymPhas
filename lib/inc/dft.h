...
namespace symphas::dft
{
	...
	void long_dft(scalar_t* data, complex_t* out, iter_type L, iter_type M, iter_type N, bool backward = false);
	void long_dft(complex_t* data, complex_t* out, iter_type L, bool backward = false);
	void long_dft(complex_t* data, complex_t* out, iter_type L, iter_type M, bool backward = false);
	void long_dft(complex_t* data, complex_t* out, iter_type L, iter_type M, iter_type N, bool backward = false);
