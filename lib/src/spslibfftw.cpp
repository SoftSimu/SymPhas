...
fftw_plan symphas::dft::new_fftw_plan<1, complex_t, complex_t>::operator()(
	fftw_complex* src, fftw_complex* target, const len_type* dims, bool estimate, bool backward)
{
	return fftw_plan_dft_1d(dims[0], 
...
{
	return fftw_plan_dft_r2c_1d(dims[0], 
...
{
	return fftw_plan_dft_c2r_1d(dims[0], 
		reinterpret_cast<fftw_complex*>(src), 
...
void symphas::dft::fftw_execute(fftw_plan p)
{
	::fftw_execute(p);
}
...
void symphas::dft::fftw_free(fftw_complex*& arr)
{
	::fftw_free(arr);
}
